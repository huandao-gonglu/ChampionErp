...
export const useWorkflowStore = defineStore('workflow', () => {
  ...
  return {
    ...
    browserCollectRows: combined.browserCollectRows,
    ...
    collectFromBrowserTabs: combined.collectFromBrowserTabs,
    ...
    claimProductsToDrafts: combined.claimProductsToDrafts,
