...
export const useWorkflowStore = defineStore('workflow', () => {
  ...
  return {
    ...
    categoryAttributeTranslationEnabled: combined.categoryAttributeTranslationEnabled,
    ...
    setCategoryAttributeTranslationEnabled: combined.setCategoryAttributeTranslationEnabled,
