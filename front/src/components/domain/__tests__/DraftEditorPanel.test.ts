...
const storeConfig = {
  mercadolibre: {
    ...
    marketplace_bindings: [
      { seller_id: 'seller-mx-full', site_id: 'MLM', logistic_type: 'fulfillment', business_model: 'cross_border' },
      { seller_id: 'seller-mx', site_id: 'MLM', logistic_type: 'remote', business_model: 'cross_border' },
      { seller_id: 'seller-co', site_id: 'MCO', logistic_type: 'remote', business_model: 'cross_border' },
      { seller_id: 'seller-br', site_id: 'MLB', logistic_type: 'remote', business_model: 'cross_border' },
    ],
  },
}
