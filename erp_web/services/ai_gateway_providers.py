"""AI Provider implementations and transport-specific gateway internals."""
...
# Provider 运行期统一使用拆分后的解析/探测公共实现。下面的显式别名也保留了
# 旧模块内私有函数被外部调试脚本引用时的名称稳定性，同时避免两份逻辑漂移。

parse_json_text = gateway_parsing.parse_json_text
_chat_completions_url = gateway_parsing._chat_completions_url
_responses_url = gateway_parsing._responses_url
...
_chat_response_text = gateway_parsing._chat_response_text
_read_chat_stream_text = gateway_parsing._read_chat_stream_text
_read_responses_stream_text = gateway_parsing._read_responses_stream_text
_parse_chat_json_text_or_payload = gateway_parsing._parse_chat_json_text_or_payload
_responses_input = gateway_parsing._responses_input
...
_sanitize_cli_error = gateway_parsing._sanitize_cli_error

_probe_options = probe_runtime._probe_options
_probe_messages = probe_runtime._probe_messages
_probe_image_prompt = probe_runtime._probe_image_prompt
_web_search_probe_date_iso = probe_runtime._web_search_probe_date_iso
_web_search_probe_prompt = probe_runtime._web_search_probe_prompt
_capability_test_outcome = probe_runtime._capability_test_outcome
_validate_web_search_probe_data = probe_runtime._validate_web_search_probe_data
_validate_web_search_probe = probe_runtime._validate_web_search_probe
_valid_base64_image = probe_runtime._valid_base64_image
_existing_image_path = probe_runtime._existing_image_path
_cli_image_probe_data_from_text = probe_runtime._cli_image_probe_data_from_text
_validate_cli_image_generate_probe = probe_runtime._validate_cli_image_generate_probe
_cli_image_generate_probe_prompt = probe_runtime._cli_image_generate_probe_prompt
_browser_image_probe_data_from_result = probe_runtime._browser_image_probe_data_from_result
_validate_browser_image_generate_probe = probe_runtime._validate_browser_image_generate_probe
_multipart_body = probe_runtime._multipart_body
_capability_error_text = probe_runtime._capability_error_text
...
class _HttpCapabilityProbeMixin:
    ...
    def probe_capability(
        ...
        if capability == ai_model_config.CAP_CHAT:
            ...
            profile = _probe_json_capability(
                model,
                api_key,
                model_name,
                timeout,
            ...
            profile = _probe_web_search_capability(
                model,
                api_key,
                model_name,
                timeout,
            ...
            _probe_image_generate_capability(
...
class CodexCliProvider(AiChatProvider):
    ...
    def probe_capability(
        ...
        if capability == ai_model_config.CAP_CHAT:
            ...
            _probe_cli_web_search_capability(
                app_dir,
                context.model,
                context.timeout,
            ...
            _probe_cli_image_generate_capability(
                app_dir,
                context.model,
                context.timeout,
        ...
        return _default_capability_profile(context.model, capability, tested=True)
...
class BrowserAiProvider(AiChatProvider):
    ...
    def probe_capability(
        ...
        if capability == ai_model_config.CAP_CHAT:
            ...
            _probe_browser_web_search_capability(
                app_dir,
                context.model,
                context.timeout,
                messages(options, probe_runtime._web_search_probe_prompt()),
            ...
            _probe_browser_image_generate_capability(
                app_dir,
                context.model,
                context.timeout,
                messages(options, probe_runtime._cli_image_generate_probe_prompt()),
