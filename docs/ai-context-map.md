...
- AI model config and unified gateway: `erp_web/services/ai_model_config.py`, `erp_web/services/ai_gateway.py`, `erp_web/services/config_service.py`, `erp_web/app_config.py`
