...
- Mercado Libre live category lookup and attribute schemas: `erp_web/runtime_units/category_store.py`, `erp_web/runtime_units/category_refresh.py`. Category search calls Mercado Libre live endpoints and does not read or write local category data stores.
